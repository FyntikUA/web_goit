from View.base_view import ConsoleView, EventConsoleView
...
class EventManager:
    ...
    def search_event(self):
        ...
        if found_events:
            ...
            for event in found_events:
                self.view.display_single_event(event)
        else:
            self.view.display_error(f"No events found with title '{title}'.")
    ...
    def show_upcoming_events(self):
        ...
        if upcoming_events:
            ...
            self.view.display_event_list(self.events)
        else:
